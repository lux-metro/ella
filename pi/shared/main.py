...
Qué hace:
  ...
  2. Inicia el motor de audio (en hilo principal)
  3. Si algo falla, lo registra y permite que systemd reinicie el servicio
...
def main():
    ...
    # Paso 2: Iniciar motor de audio
    # Esta llamada BLOQUEA hasta que se detiene el motor.
    _motor = MotorDeAudio(config=config)
