...
Para desactivarlo: sección **"Zona de peligro"** del Panel Web (reinicia la Pi) o `bash ~/ella/repo/pi/revertir_wifi.sh`. Ambos usan NetworkManager (nmcli). La misma sección incluye un botón para **reiniciar la Raspberry Pi**.
